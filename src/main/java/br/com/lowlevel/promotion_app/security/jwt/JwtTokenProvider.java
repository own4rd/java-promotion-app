package br.com.lowlevel.promotion_app.security.jwt;
...
public class JwtTokenProvider {
    ...
    private final long ONE_HOUR_MILLISECONDS = 36000000;
    @Value("${security.jwt.token.expire-length:default}")
    private final long validityInMilliseconds = ONE_HOUR_MILLISECONDS;
